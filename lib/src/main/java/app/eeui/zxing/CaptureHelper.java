...
import app.eeui.zxing.camera.FrontLightMode;
...
public class CaptureHelper implements CaptureLifecycle,CaptureTouchEvent,CaptureManager, SurfaceHolder.Callback  {
    ...
    /**
     * use {@link #CaptureHelper(Fragment, SurfaceView, ViewfinderView, View, Boolean)}
     * @param fragment
     * @param surfaceView
    ...
    public CaptureHelper(Fragment fragment, SurfaceView surfaceView, ViewfinderView viewfinderView){
        this(fragment,surfaceView,viewfinderView,null,true);
    }

    public CaptureHelper(Fragment fragment, SurfaceView surfaceView, ViewfinderView viewfinderView,View ivTorch,Boolean asynch){
        this(fragment.getActivity(),surfaceView,viewfinderView,ivTorch,asynch);
    }

    /**
     *  use {@link #CaptureHelper(Activity, SurfaceView, ViewfinderView, View, Boolean)}
     * @param activity
     * @param surfaceView
     * @param viewfinderView
     */
    ...
    public CaptureHelper(Activity activity,SurfaceView surfaceView,ViewfinderView viewfinderView){
        this(activity,surfaceView,viewfinderView,null,true);
    }
     ...
     * @param asynch
     */
    public CaptureHelper(Activity activity,SurfaceView surfaceView,ViewfinderView viewfinderView,View ivTorch,Boolean asynch){
    ...
    public void onResume(){
        ...
        if (hasSurface) {
            if (isAsynch) {
                new initCameraTask(surfaceHolder).execute();
            } else {
    ...
    class initCameraTask extends AsyncTask<String, String, String> {
        SurfaceHolder mSurfaceHolder;

        initCameraTask(SurfaceHolder surfaceHolder) {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (!hasSurface) {
            hasSurface = true;
            if (isAsynch) {
                new initCameraTask(holder).execute();
            } else {
                initCamera(holder);
            }
        }
